export const siteConfig = {
  ...
  siteUrl: process.env.NEXT_PUBLIC_SITE_URL ?? process.env.DEPLOY_PRIME_URL ?? process.env.URL ?? (process.env.NODE_ENV==="production"?"https://credmarvi.netlify.app":"http://localhost:3000"),
