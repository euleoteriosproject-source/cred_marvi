...
export function LeadWizard(){
  ...
  function submit(){const payload:Values={...values,status:"NEW",startedAt:startedAt.current};trackEvent("lead_submit_success",{result:"whatsapp"});window.location.assign(whatsappUrl(leadChecklistMessage(payload)))}
