...
export const metadata:Metadata={title:"Termos de Uso",description:"Consulte as condições de uso do site e do atendimento inicial da Marvi Finance.",alternates:{canonical:"/termos"}};
const sections=[
  ...
  ["Sem garantia de aprovação","A Marvi Finance não garante aprovação, taxas, limites ou prazos. Toda solução depende da análise e dos critérios das instituições responsáveis."],
