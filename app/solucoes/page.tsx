...
export const metadata:Metadata={title:"Soluções financeiras",description:"Conheça as principais soluções atendidas pela Marvi Finance para pessoas e empresas.",alternates:{canonical:"/solucoes"}};
